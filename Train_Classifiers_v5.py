from nltk.corpus import sentence_polarity,twitter_samples,opinion_lexicon
...
if parse_data:
        ...
        print "Total time to finish positive tweets:"+str(timeendpos-timestartpos)
        ########################################################
        ...
        print "Total time to finish negative tweets:"+str(timeendneg-timestartneg)
        ########################################################
        ...
        print 'time to run featuresets:'+str(featuresetsend-featuresetsstart)
        ...
        print 'time to load featuresets='+str(tendloadfeaturesets-tstartloadfeaturesets)
...
if traindata:
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/naivebayes.pickle','wb')
	...
	pickle.dump(classifier,save_classifier)#now we've saved the classifier
	save_classifier.close()

	#now load the classifier from the pickle
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/MNB.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/BNB.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/LR.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/SGD.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/SVC.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/LinearSVC.pickle','wb')
	...
	save_classifier=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/NuSVC.pickle','wb')
	pickle.dump(NuSVC_classifier,save_classifier)
	save_classifier.close()
else:
	print('entered else')
	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/naivebayes.pickle',"rb")
	classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/MNB.pickle',"rb")
	MNB_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/BNB.pickle',"rb")
	BNB_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/LR.pickle',"rb")
	LogisticRegression_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/SGD.pickle',"rb")
	SGD_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/SVC.pickle',"rb")
	SVC_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/LinearSVC.pickle',"rb")
	LinearSVC_classifier=pickle.load(classifier_f)
	classifier_f.close()

	classifier_f=open('/home/ben/Dropbox/python/Twitter_Sentiment/pickled_classifiers/NuSVC.pickle',"rb")
